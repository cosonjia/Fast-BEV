...
class Collect3D(object):
    ...
    def __init__(self,
                 keys,
                 meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img','lidar2image',
                            'depth2img', 'cam2img', 'pad_shape',
                            'scale_factor', 'flip', 'pcd_horizontal_flip',
                            'pcd_vertical_flip', 'box_mode_3d', 'box_type_3d','velocity',
                             'img_norm_cfg', 'pcd_trans', 'sample_idx', 'timestamp', 'token',
                            'pcd_scale_factor', 'pcd_rotation', 'pts_filename',
                            'transformation_3d_flow', 'img_info','img_prefix', 'image_paths')):
        self.keys = keys
